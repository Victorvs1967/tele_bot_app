...
second_add = ['отношения с друзьями и длизкими.', 'работу и деловые вопросы, которые могут так не кстати помешать планам.', 'себя и свое здоровье, иначе к вечеру возможен полный раздрай.', 'бытовые вопросы - особенно те, которые не доделали вчера.', 'отдых, чтобы не превратить себя в загнанную лошадь к концу месяца.']
